...
if(UNIX AND NOT APPLE)
	find_path(Poco_RUNTIME_LIBRARY_DIRS
		NAMES libPocoFoundation libPocoFoundation.dll.a libPocoFoundation.dll libPocoFoundation.a libPocoFoundation.dylib
		HINTS ${Poco_HINTS}/..
		PATH_SUFFIXES 
			bin
			lib
...
foreach( component ${components} )
	...
	if(NOT Poco_${component}_LIBRARY)
		find_library(
			...
			NAMES libPoco${component} libPoco${component}.dll libPoco${component}.dll.a libPoco${component}.dylib libPoco${component}.a
	...
	if(NOT Poco_${component}_LIBRARY_DEBUG)
		find_library(
			...
			Names libPoco${component}d libPoco${component}d.dll libPoco${component}d.a libPoco${component}d.dll.a libPoco${component}d.dylib
			HINTS ${Poco_HINTS_LIB}
			PATH_SUFFIXES
				lib
				bin
